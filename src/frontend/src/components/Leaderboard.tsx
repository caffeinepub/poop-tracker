...
export default function Leaderboard() {
  ...
  // Check if same person holds both titles (MVP)
  const isMVP = kingPooper.principal.toString() === kingWiper.principal.toString();
  ...
  return (
    <Card className="border-2">
      <CardHeader>
        ...
        <CardDescription>Bow down to the champions of the throne</CardDescription>
      </CardHeader>
      <CardContent>
